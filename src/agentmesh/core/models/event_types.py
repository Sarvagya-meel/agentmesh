...
class EventType(StrEnum):
    ...
    DIRECT_REQUEST_SUBMITTED = "DIRECT_REQUEST_SUBMITTED"
    DIRECT_REQUEST_COMPLETED = "DIRECT_REQUEST_COMPLETED"
    DIRECT_REQUEST_FAILED = "DIRECT_REQUEST_FAILED"
    TASK_RERUN_REQUESTED = "TASK_RERUN_REQUESTED"
    SUPERVISOR_ACTION_REQUESTED = "SUPERVISOR_ACTION_REQUESTED"
    SUPERVISOR_ACTION_RETRY_SCHEDULED = "SUPERVISOR_ACTION_RETRY_SCHEDULED"
    SUPERVISOR_ACTION_COMPLETED = "SUPERVISOR_ACTION_COMPLETED"
    SUPERVISOR_ACTION_FAILED = "SUPERVISOR_ACTION_FAILED"
    ...
    TASK_OUTPUT_RECEIVED = "TASK_OUTPUT_RECEIVED"
    TASK_VALIDATION_REQUESTED = "TASK_VALIDATION_REQUESTED"
