...
- `src/agentmesh/core/models/` contains the canonical Pydantic v2 domain models
- Repository modules under `src/agentmesh/**/database/` own SQL and conversion
  from database rows to domain models
